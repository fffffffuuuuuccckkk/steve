...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_epoch', default=None,
                    type=int, help='random seed')
    confounder_cli_names = [
        'confounder_dep_mode',
        'confounder_extractor',
        'confounder_dim',
        'confounder_num_heads',
        'confounder_attention_dropout',
        'confounder_graph_embed_dim',
        'confounder_variational',
        'confounder_kl_weight',
        'confounder_dep_warmup_epochs',
        'confounder_dep_ramp_epochs',
        'confounder_projection_ridge',
        'confounder_dep_detach_target',
        'gci_weight',
        'gci_graph_align_weight',
        'gci_graph_hops',
        'gci_symmetrize_adj',
        'gci_add_self_loops',
        'scd_weight',
    ...
    for conf_name in confounder_cli_names:
        parser.add_argument('--' + conf_name, default=None, type=parse_cli_value)
    ...
    for conf_name in confounder_cli_names:
        value = getattr(args, conf_name, None)
        if value is not None:
            configs[conf_name] = value
