...
- Checkpoint: `/data/OuXiaoyu/STEVE_CODE/STEVE/experiments/NYCTaxi_TDS/fpem_agcrn_aligned_pretrained_inv_input_add_module_validity_progressive_gmm_0720_add_progressive_gmm_kmax3_common020_seed2025/best_val_model.pth`
- Experiment: `/data/OuXiaoyu/STEVE_CODE/STEVE/experiments/NYCTaxi_TDS/fpem_agcrn_aligned_pretrained_inv_input_add_module_validity_progressive_gmm_0720_add_progressive_gmm_kmax3_common020_seed2025`
- Seed: `2025`
...
- Validation Hungarian mapping: `{0: 2, 1: 0, 2: 1}`
- Best-fixed expert from validation: `2`

## Routing summary
- `best_fixed`: test_avg_mae=7.804054498672485
- `random_uniform_top1`: test_avg_mae=7.804291820526123
- `random_prior_top1`: test_avg_mae=7.8043276309967045
- `shuffled_gmm_route`: test_avg_mae=7.804312252998352
- `gmm_hard_identity`: test_avg_mae=7.804408311843872
- `gmm_hard_val_hungarian`: test_avg_mae=7.804026126861572
- `gmm_hard_val_independent`: test_avg_mae=7.804026126861572
- `uniform_all_experts`: test_avg_mae=7.803970813751221
- `oracle_top1`: test_avg_mae=7.798339366912842

## Cross-MAE interpretation
- Identity same as Hungarian: `False`
- Identity minus Hungarian validation MAE sum: `0.009208664439960046`
- Independent and Hungarian agree: `True`
- Per-cluster second-best margin: `[0.006666729705130159, 0.0006706834306093867, 0.0018712513042213885]`
