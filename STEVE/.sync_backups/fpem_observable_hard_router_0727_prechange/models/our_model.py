...
class StableST(nn.Module):
    ...
    def get_load_level_state_for_checkpoint(self):
        return {
            ...
            "source": "latest historical x[:, -1].mean over nodes and channels",
    ...
    def forward_features(self, x, time_label=None, exog=None, training=False, sample_index=None):
    ...
    def calculate_loss(
        ...
        if self.fpem_use_env_route and self._route_enabled_for_epoch(training, epoch):
            if self.fpem_use_load_level_experts:
                load_expert_loss, environment_gate_loss, load_logs, load_gate_diagnostics = (
                    load_level_expert_gate_losses(
                        output,
                        target,
                        scaler,
                ...
                route_loss = (
                    ...
                    + self.fpem_lambda_environment_gate * environment_gate_loss
                )
        ...
        self.latest_fpem_outputs = {
            ...
            "gate_target": None if load_gate_diagnostics is None else load_gate_diagnostics.get("gate_target"),
