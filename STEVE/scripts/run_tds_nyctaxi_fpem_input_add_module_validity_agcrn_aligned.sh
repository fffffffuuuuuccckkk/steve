...
export BEST_SELECTION_SPLIT=${BEST_SELECTION_SPLIT:-val}
...
ALL_CASES=(
  ...
  obs_k1_environment_hard_router
  obs_k3_original_learned_experts
  obs_k3_fixed_always_environment
  obs_k3_fixed_hard_router
  obs_k3_random_balanced_hard_router
  obs_k1_conservative_inv_override_regret_router
  obs_k1_counterfactual_risk_router
  add_obj_none
  add_obj_future
  add_obj_swap
  add_obj_full
...
summary_metric_values() {
  ...
  if [ -z "$summary_json" ] || [ ! -f "$summary_json" ]; then
    printf 'NA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA'
    return
  fi
  "$PYTHON" - "$summary_json" <<'PY'
import json, math, sys
...
keys = [
    ...
    "fpem_conservative_inv_override", "fpem_override_threshold", "fpem_override_margin",
    "conservative_selective_hard_routing_mae", "conservative_all_environment_mae",
    "conservative_all_invariant_mae", "conservative_oracle_mae",
    "conservative_net_routing_gain", "conservative_invariant_switch_coverage",
    "fpem_counterfactual_risk_router", "counterfactual_risk_routed_mae",
    "counterfactual_risk_all_environment_mae", "counterfactual_risk_all_invariant_mae",
    "counterfactual_risk_oracle_mae", "counterfactual_risk_net_gain",
    "counterfactual_risk_regret", "counterfactual_risk_inv_route_ratio",
    "counterfactual_risk_stage2_active",
    "counterfactual_risk_all_samples_used_for_router",
...
record_summary() {
  ...
  (
    ...
    if [ ! -s "$SUMMARY_FILE" ]; then
      printf 'case\tseed\tstatus\trun_name\tbest_epoch\tbest_val_loss\ttest_avg_mae\ttest_mixed_mae\troute_head_mode\tfpem_env_route_target_mode\tfpem_force_uniform_route\tfpem_env_rep_ablation\teffective_expert_number\tprototype_pairwise_cosine\tloss_future_mi\tloss_swap\tfpem_conservative_inv_override\tfpem_override_threshold\tfpem_override_margin\tconservative_selective_hard_routing_mae\tconservative_all_environment_mae\tconservative_all_invariant_mae\tconservative_oracle_mae\tconservative_net_routing_gain\tconservative_invariant_switch_coverage\tfpem_counterfactual_risk_router\tcounterfactual_risk_routed_mae\tcounterfactual_risk_all_environment_mae\tcounterfactual_risk_all_invariant_mae\tcounterfactual_risk_oracle_mae\tcounterfactual_risk_net_gain\tcounterfactual_risk_regret\tcounterfactual_risk_inv_route_ratio\tcounterfactual_risk_stage2_active\tcounterfactual_risk_all_samples_used_for_router\tcounterfactual_risk_training_uses_route\tcounterfactual_risk_deploy_route_active\tdetail\n' > "$SUMMARY_FILE"
    fi
    printf '%s\t%s\t%s\t%s\t%s\t%s\n' \
...
case_args() {
  ...
  case "$name" in
    ...
    add_k3_proto_sinkhorn_plain)
      ...
      ;;
    k1_environment_expert)
      printf '%s\n' --fpem_env_route_head_mode hyper_inv_film_proto_input_add --fpem_env_route_k 1 --fpem_use_load_level_experts true --fpem_load_level_k 1 --fpem_load_level_mode train_quantile --fpem_randomize_train_load_level false --fpem_ignore_future_c true --fpem_use_environment_gate true --fpem_environment_gate_hidden_dim 64 --fpem_environment_gate_warmup_epochs 5 --fpem_environment_gate_margin_relative 0.01 --fpem_environment_gate_temperature 0.05 --fpem_lambda_environment_gate 1.0 --fpem_lambda_load_expert 0.2 --fpem_env_route_use_inv_fallback_expert false --fpem_use_env_prototype_router false --fpem_use_sinkhorn_route false --fpem_use_future_mi false --fpem_lambda_future_mi 0.0 --fpem_use_swap false --fpem_lambda_swap 0.0 --fpem_use_club_mi false --fpem_lambda_club_mi 0.0 --early_stop_test_avg_mae_epoch 0 --save_test_selected_checkpoints false
      ;;
    k3_unsupervised_experts)
      printf '%s\n' --fpem_env_route_head_mode hyper_inv_film_proto_input_add --fpem_env_route_k 3 --fpem_use_load_level_experts false --fpem_ignore_future_c true --fpem_use_environment_gate false --fpem_env_route_use_inv_fallback_expert false --fpem_use_env_prototype_router false --fpem_use_sinkhorn_route false --fpem_env_route_target_mode prediction_oracle --fpem_env_route_train_mode soft_oracle --fpem_force_uniform_route false --fpem_use_future_mi false --fpem_lambda_future_mi 0.0 --fpem_use_swap false --fpem_lambda_swap 0.0 --fpem_use_club_mi false --fpem_lambda_club_mi 0.0 --early_stop_test_avg_mae_epoch 0 --save_test_selected_checkpoints false
      ;;
    k3_load_level_always_env)
      printf '%s\n' --fpem_env_route_head_mode hyper_inv_film_proto_input_add --fpem_env_route_k 3 --fpem_use_load_level_experts true --fpem_load_level_k 3 --fpem_load_level_mode train_quantile --fpem_randomize_train_load_level false --fpem_ignore_future_c true --fpem_use_environment_gate false --fpem_environment_gate_hidden_dim 64 --fpem_environment_gate_warmup_epochs 5 --fpem_environment_gate_margin_relative 0.01 --fpem_environment_gate_temperature 0.05 --fpem_lambda_environment_gate 1.0 --fpem_lambda_load_expert 0.2 --fpem_env_route_use_inv_fallback_expert false --fpem_use_env_prototype_router false --fpem_use_sinkhorn_route false --fpem_use_future_mi false --fpem_lambda_future_mi 0.0 --fpem_use_swap false --fpem_lambda_swap 0.0 --fpem_use_club_mi false --fpem_lambda_club_mi 0.0 --early_stop_test_avg_mae_epoch 0 --save_test_selected_checkpoints false
      ;;
    k3_load_level_gate)
      printf '%s\n' --fpem_env_route_head_mode hyper_inv_film_proto_input_add --fpem_env_route_k 3 --fpem_use_load_level_experts true --fpem_load_level_k 3 --fpem_load_level_mode train_quantile --fpem_randomize_train_load_level false --fpem_ignore_future_c true --fpem_use_environment_gate true --fpem_environment_gate_hidden_dim 64 --fpem_environment_gate_warmup_epochs 5 --fpem_environment_gate_margin_relative 0.01 --fpem_environment_gate_temperature 0.05 --fpem_lambda_environment_gate 1.0 --fpem_lambda_load_expert 0.2 --fpem_env_route_use_inv_fallback_expert false --fpem_use_env_prototype_router false --fpem_use_sinkhorn_route false --fpem_use_future_mi false --fpem_lambda_future_mi 0.0 --fpem_use_swap false --fpem_lambda_swap 0.0 --fpem_use_club_mi false --fpem_lambda_club_mi 0.0 --early_stop_test_avg_mae_epoch 0 --save_test_selected_checkpoints false
      ;;
    k3_random_load_level_gate)
      printf '%s\n' --fpem_env_route_head_mode hyper_inv_film_proto_input_add --fpem_env_route_k 3 --fpem_use_load_level_experts true --fpem_load_level_k 3 --fpem_load_level_mode train_quantile --fpem_randomize_train_load_level true --fpem_random_load_level_seed 20260727 --fpem_ignore_future_c true --fpem_use_environment_gate true --fpem_environment_gate_hidden_dim 64 --fpem_environment_gate_warmup_epochs 5 --fpem_environment_gate_margin_relative 0.01 --fpem_environment_gate_temperature 0.05 --fpem_lambda_environment_gate 1.0 --fpem_lambda_load_expert 0.2 --fpem_env_route_use_inv_fallback_expert false --fpem_use_env_prototype_router false --fpem_use_sinkhorn_route false --fpem_use_future_mi false --fpem_lambda_future_mi 0.0 --fpem_use_swap false --fpem_lambda_swap 0.0 --fpem_use_club_mi false --fpem_lambda_club_mi 0.0 --early_stop_test_avg_mae_epoch 0 --save_test_selected_checkpoints false
      ;;
    obs_k1_environment_hard_router)
      printf '%s\n' --fpem_env_route_head_mode hyper_inv_film_proto_input_add --fpem_env_route_k 1 --fpem_use_observable_load_prior true --fpem_observable_load_prior_cache "${PROJECT_DIR}/data/NYCTaxi/observable_load_prior_k3_v1.npz" --fpem_observable_load_random_seed 314159 --fpem_use_load_level_experts true --fpem_load_level_k 1 --fpem_load_level_mode train_quantile --fpem_use_random_balanced_assignment false --fpem_ignore_future_c true --fpem_hyper_alpha_mode fixed_one --fpem_use_environment_gate false --fpem_use_hard_environment_router true --fpem_hard_router_hidden_dim 64 --fpem_hard_router_warmup_epochs 5 --fpem_hard_router_relative_margin 0.01 --fpem_lambda_hard_router 1.0 --fpem_lambda_load_expert 0.2 --fpem_env_route_use_inv_fallback_expert false --fpem_use_env_prototype_router false --fpem_use_sinkhorn_route false --fpem_use_future_mi false --fpem_lambda_future_mi 0.0 --fpem_use_swap false --fpem_lambda_swap 0.0 --fpem_use_club_mi false --fpem_lambda_club_mi 0.0 --fpem_use_env_fusion false --early_stop_test_avg_mae_epoch 0 --save_test_selected_checkpoints false
      ;;
    obs_k3_original_learned_experts)
      printf '%s\n' --fpem_env_route_head_mode hyper_inv_film_proto_input_add --fpem_env_route_k 3 --fpem_use_observable_load_prior true --fpem_observable_load_prior_cache "${PROJECT_DIR}/data/NYCTaxi/observable_load_prior_k3_v1.npz" --fpem_observable_load_random_seed 314159 --fpem_use_load_level_experts false --fpem_load_level_k 3 --fpem_use_random_balanced_assignment false --fpem_ignore_future_c true --fpem_hyper_alpha_mode fixed_one --fpem_use_environment_gate false --fpem_use_hard_environment_router false --fpem_env_route_use_inv_fallback_expert false --fpem_use_env_prototype_router false --fpem_use_sinkhorn_route false --fpem_env_route_target_mode prediction_oracle --fpem_env_route_train_mode soft_oracle --fpem_force_uniform_route false --fpem_use_future_mi false --fpem_lambda_future_mi 0.0 --fpem_use_swap false --fpem_lambda_swap 0.0 --fpem_use_club_mi false --fpem_lambda_club_mi 0.0 --fpem_use_env_fusion false --early_stop_test_avg_mae_epoch 0 --save_test_selected_checkpoints false
      ;;
    obs_k3_fixed_always_environment)
      printf '%s\n' --fpem_env_route_head_mode hyper_inv_film_proto_input_add --fpem_env_route_k 3 --fpem_use_observable_load_prior true --fpem_observable_load_prior_cache "${PROJECT_DIR}/data/NYCTaxi/observable_load_prior_k3_v1.npz" --fpem_observable_load_random_seed 314159 --fpem_use_load_level_experts true --fpem_load_level_k 3 --fpem_load_level_mode train_quantile --fpem_use_random_balanced_assignment false --fpem_ignore_future_c true --fpem_hyper_alpha_mode fixed_one --fpem_use_environment_gate false --fpem_use_hard_environment_router false --fpem_hard_router_hidden_dim 64 --fpem_hard_router_warmup_epochs 5 --fpem_hard_router_relative_margin 0.01 --fpem_lambda_hard_router 0.0 --fpem_lambda_load_expert 0.2 --fpem_env_route_use_inv_fallback_expert false --fpem_use_env_prototype_router false --fpem_use_sinkhorn_route false --fpem_use_future_mi false --fpem_lambda_future_mi 0.0 --fpem_use_swap false --fpem_lambda_swap 0.0 --fpem_use_club_mi false --fpem_lambda_club_mi 0.0 --fpem_use_env_fusion false --early_stop_test_avg_mae_epoch 0 --save_test_selected_checkpoints false
      ;;
    obs_k3_fixed_hard_router)
      printf '%s\n' --fpem_env_route_head_mode hyper_inv_film_proto_input_add --fpem_env_route_k 3 --fpem_use_observable_load_prior true --fpem_observable_load_prior_cache "${PROJECT_DIR}/data/NYCTaxi/observable_load_prior_k3_v1.npz" --fpem_observable_load_random_seed 314159 --fpem_use_load_level_experts true --fpem_load_level_k 3 --fpem_load_level_mode train_quantile --fpem_use_random_balanced_assignment false --fpem_ignore_future_c true --fpem_hyper_alpha_mode fixed_one --fpem_use_environment_gate false --fpem_use_hard_environment_router true --fpem_hard_router_hidden_dim 64 --fpem_hard_router_warmup_epochs 5 --fpem_hard_router_relative_margin 0.01 --fpem_lambda_hard_router 1.0 --fpem_lambda_load_expert 0.2 --fpem_env_route_use_inv_fallback_expert false --fpem_use_env_prototype_router false --fpem_use_sinkhorn_route false --fpem_use_future_mi false --fpem_lambda_future_mi 0.0 --fpem_use_swap false --fpem_lambda_swap 0.0 --fpem_use_club_mi false --fpem_lambda_club_mi 0.0 --fpem_use_env_fusion false --early_stop_test_avg_mae_epoch 0 --save_test_selected_checkpoints false
      ;;
    obs_k3_random_balanced_hard_router)
      printf '%s\n' --fpem_env_route_head_mode hyper_inv_film_proto_input_add --fpem_env_route_k 3 --fpem_use_observable_load_prior true --fpem_observable_load_prior_cache "${PROJECT_DIR}/data/NYCTaxi/observable_load_prior_k3_v1.npz" --fpem_observable_load_random_seed 314159 --fpem_use_load_level_experts true --fpem_load_level_k 3 --fpem_load_level_mode train_quantile --fpem_use_random_balanced_assignment true --fpem_ignore_future_c true --fpem_hyper_alpha_mode fixed_one --fpem_use_environment_gate false --fpem_use_hard_environment_router true --fpem_hard_router_hidden_dim 64 --fpem_hard_router_warmup_epochs 5 --fpem_hard_router_relative_margin 0.01 --fpem_lambda_hard_router 1.0 --fpem_lambda_load_expert 0.2 --fpem_env_route_use_inv_fallback_expert false --fpem_use_env_prototype_router false --fpem_use_sinkhorn_route false --fpem_use_future_mi false --fpem_lambda_future_mi 0.0 --fpem_use_swap false --fpem_lambda_swap 0.0 --fpem_use_club_mi false --fpem_lambda_club_mi 0.0 --fpem_use_env_fusion false --early_stop_test_avg_mae_epoch 0 --save_test_selected_checkpoints false
      ;;
    obs_k1_conservative_inv_override_regret_router)
      printf '%s\n' --fpem_env_route_head_mode hyper_inv_film_proto_input_add --fpem_env_route_k 1 --fpem_use_observable_load_prior true --fpem_observable_load_prior_cache "${PROJECT_DIR}/data/NYCTaxi/observable_load_prior_k3_v1.npz" --fpem_observable_load_random_seed 314159 --fpem_use_load_level_experts true --fpem_load_level_k 1 --fpem_load_level_mode train_quantile --fpem_use_random_balanced_assignment false --fpem_ignore_future_c true --fpem_hyper_alpha_mode fixed_one --fpem_use_environment_gate false --fpem_use_hard_environment_router false --fpem_conservative_inv_override true --fpem_override_margin "${FPEM_OVERRIDE_MARGIN:-0.0}" --fpem_override_threshold "${FPEM_OVERRIDE_THRESHOLD:-0.5}" --fpem_override_threshold_grid "${FPEM_OVERRIDE_THRESHOLD_GRID:-0.50,0.55,0.60,0.65,0.70,0.75,0.80,0.85,0.90,0.95}" --fpem_override_margin_grid "${FPEM_OVERRIDE_MARGIN_GRID:-}" --fpem_override_threshold_selection_split "${FPEM_OVERRIDE_THRESHOLD_SELECTION_SPLIT:-val}" --fpem_override_weight_min "${FPEM_OVERRIDE_WEIGHT_MIN:-0.0}" --fpem_override_weight_max "${FPEM_OVERRIDE_WEIGHT_MAX:-20.0}" --fpem_harmful_switch_weight "${FPEM_HARMFUL_SWITCH_WEIGHT:-2.0}" --fpem_override_router_loss_weight "${FPEM_OVERRIDE_ROUTER_LOSS_WEIGHT:-1.0}" --fpem_hard_router_hidden_dim 64 --fpem_hard_router_warmup_epochs 0 --fpem_lambda_hard_router 0.0 --fpem_lambda_load_expert 0.2 --fpem_lambda_inv_pred "${FPEM_LAMBDA_INV_PRED:-0.2}" --fpem_env_route_use_inv_fallback_expert false --fpem_use_env_prototype_router false --fpem_use_sinkhorn_route false --fpem_env_route_lambda_balance 0.0 --fpem_env_route_lambda_diverse 0.0 --fpem_env_route_lambda_proto_align 0.0 --fpem_env_route_lambda_entropy 0.0 --fpem_env_route_lambda_route_soft 0.0 --fpem_use_future_mi false --fpem_lambda_future_mi 0.0 --fpem_use_swap false --fpem_lambda_swap 0.0 --fpem_use_club_mi false --fpem_lambda_club_mi 0.0 --fpem_use_env_fusion false --early_stop_test_avg_mae_epoch 0 --save_test_selected_checkpoints false
      ;;
    obs_k1_counterfactual_risk_router)
      printf '%s\n' --fpem_env_route_head_mode hyper_inv_film_proto_input_add --fpem_env_route_k 1 --fpem_use_observable_load_prior true --fpem_observable_load_prior_cache "${PROJECT_DIR}/data/NYCTaxi/observable_load_prior_k3_v1.npz" --fpem_observable_load_random_seed 314159 --fpem_use_load_level_experts true --fpem_load_level_k 1 --fpem_load_level_mode train_quantile --fpem_use_random_balanced_assignment false --fpem_ignore_future_c true --fpem_hyper_alpha_mode fixed_one --fpem_use_environment_gate false --fpem_use_hard_environment_router false --fpem_conservative_inv_override false --fpem_counterfactual_risk_router true --fpem_counterfactual_risk_stage2_start_epoch "${FPEM_COUNTERFACTUAL_RISK_STAGE2_START_EPOCH:-20}" --fpem_counterfactual_risk_regression_weight "${FPEM_COUNTERFACTUAL_RISK_REGRESSION_WEIGHT:-1.0}" --fpem_counterfactual_risk_ranking_weight "${FPEM_COUNTERFACTUAL_RISK_RANKING_WEIGHT:-0.5}" --fpem_counterfactual_risk_router_loss_weight "${FPEM_COUNTERFACTUAL_RISK_ROUTER_LOSS_WEIGHT:-1.0}" --fpem_counterfactual_risk_weight_min "${FPEM_COUNTERFACTUAL_RISK_WEIGHT_MIN:-0.0}" --fpem_counterfactual_risk_weight_max "${FPEM_COUNTERFACTUAL_RISK_WEIGHT_MAX:-20.0}" --fpem_counterfactual_risk_ranking_temperature "${FPEM_COUNTERFACTUAL_RISK_RANKING_TEMPERATURE:-1.0}" --fpem_hard_router_hidden_dim 64 --fpem_hard_router_warmup_epochs 0 --fpem_lambda_hard_router 0.0 --fpem_lambda_load_expert 0.2 --fpem_lambda_inv_pred "${FPEM_LAMBDA_INV_PRED:-0.2}" --fpem_env_route_use_inv_fallback_expert false --fpem_use_env_prototype_router false --fpem_use_sinkhorn_route false --fpem_env_route_lambda_balance 0.0 --fpem_env_route_lambda_diverse 0.0 --fpem_env_route_lambda_proto_align 0.0 --fpem_env_route_lambda_entropy 0.0 --fpem_env_route_lambda_route_soft 0.0 --fpem_use_future_mi false --fpem_lambda_future_mi 0.0 --fpem_use_swap false --fpem_lambda_swap 0.0 --fpem_use_club_mi false --fpem_lambda_club_mi 0.0 --fpem_use_env_fusion false --early_stop_test_avg_mae_epoch 0 --save_test_selected_checkpoints false
      ;;
    add_obj_none)
...
run_one() {
  ...
  local -a cmd=(
    ...
    --ablation "$name"
    "${extra_args[@]}"
    --early_stop_test_avg_mae_epoch "$TEST_SELECTION_START_EPOCH"
...
for case_name in "${ALL_CASES[@]}"; do
  ...
  for seed in "${SEED_LIST[@]}"; do
    ...
    if ! truthy "$DRY_RUN" && ! truthy "$PLAN_ONLY" && [[ "$DEVICE" == cuda* ]]; then
      while ! gpu_is_available "$gpu"; do
